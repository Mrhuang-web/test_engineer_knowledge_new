...
class es_alert_his:
    ...
    def __init__(self, env='sx'):
        ...
        self.sqlfile = open(str(os.path.dirname(os.path.dirname(__file__)) + r'\\Common' +
                                r'\\selectForESList.sql'), encoding='utf-8')
...
if __name__ == "__main__":
    ...
    # 贵州
    # es_alert_his(env='release').insert(
    #     device_id='00751006000005629510',
    #     mete_code='088003',
    #     alert_start_time='2025-08-08T01:01:07.000Z',
    #     alert_end_time='2025-08-08T01:21:07.000Z')

    # 广州
    # es_alert_his(env='release').insert(
    #     device_id='00751006000005629510',
    #     mete_code='088003',
    #     alert_start_time='2025-08-08T03:01:07.000Z',
    #     alert_end_time='2025-08-08T03:21:07.000Z')

    # # 广西
    # es_alert_his(env='release').insert(
    #     device_id='00751006000005629507',
    #     mete_code='008020',
    #     alert_start_time='2025-08-08T03:01:07.000Z',
    #     alert_end_time='2025-08-08T03:21:07.000Z')
    # es_alert_his(env='release').insert(
    ...
    #     device_id='00751006000005629507',
    #     mete_code='008020',
    #     alert_start_time='2025-11-09T01:01:07.000Z',
    #     alert_end_time='2025-11-09T01:21:07.000Z')

    # 广西
    es_alert_his(env='gx').insert(
        device_id='00781006000003077481',
        mete_code='006001',
        alert_start_time='2025-11-21T01:01:07.000Z',
        alert_end_time='2025-11-21T01:21:07.000Z')

    # # 动环黑龙江  - 综资四川
    # # 变压器 transform: "003002,003006"
    # es_alert_his(env='release').insert(
    #     device_id='7312001006000005625007',
    #     mete_code='003002',
    #     alert_start_time='2025-08-08T03:01:07.000Z',
    #     alert_end_time='2025-08-08T03:21:07.000Z')
    # es_alert_his(env='release').insert(
