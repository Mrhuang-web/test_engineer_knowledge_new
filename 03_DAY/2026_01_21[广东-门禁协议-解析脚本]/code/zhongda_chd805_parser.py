...
"""
中达CHD805门禁控制器协议解析脚本
用于解析中达CHD805门禁控制器协议的16进制码流
"""

from base_parser import BaseParser

class ZhongdaCHD805Parser(BaseParser):
    """中达CHD805门禁控制器协议解析器"""
    
    def __init__(self):
        super().__init__()
        self.name = "中达CHD805门禁控制器协议"
        self.soi = b'\x7E'  # 1字节起始符
        self.eoi = b'\x0D'  # 1字节结束符
    
    def parse_packet(self, hex_string):
        """解析中达CHD805门禁控制器协议数据包"""
        # 将16进制字符串转换为字节流
...
if __name__ == "__main__":
    ...
    # 示例数据包（需要替换为实际的中达CHD805协议数据包）
    example_packet = "FF3230323530313137000000000000000000000000000000000000000001002500EE010020007E3130303138303438323030454630453030303030303030303030464143380D96FE"
    
    print("=== 中达CHD805门禁控制器协议解析示例 ===")
