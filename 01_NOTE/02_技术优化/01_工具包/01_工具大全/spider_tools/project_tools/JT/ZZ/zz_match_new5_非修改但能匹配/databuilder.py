...
class DataBuilder:
    DEVICE_FIELDS = {
        'site': [
            'address', 'alias_name', 'area_type', 'batch_num', 'business_type', 'china_tower_station_code',
            'city_id', 'collect_time', 'county_id', 'cutin_date', 'floor_number', 'if_tele_cmn_serv',
            'if_village_pass_serv', 'int_id', 'irms_province_code', 'is_headquarters_used', 'latitude',
            'lifecycle_status', 'longitude', 'pms_address_code', 'project_code', 'project_name',
            'province_id', 'qualitor', 'related_dc', 'site_type', 'standardaddress',
            'tele_cmn_serv_pro_code', 'tele_cmn_serv_pro_name', 'use_corp', 'uuid',
            'village_pass_serv_code', 'village_pass_serv_name', 'zh_label'
        ],
        'site_property': [
            'actual_pue', 'batch_num', 'city_id', 'cold_storage_time', 'collect_time', 'county_id',
            'design_pue', 'irms_province_code', 'is_attach_idc_room', 'is_cold_storage_install',
            'mains_backup_method', 'mains_capacity', 'mains_configuration_level', 'mains_nature',
            'mains_voltage_level', 'power_is_substations', 'power_monitoring_site_id',
            'power_monitoring_site_name', 'power_site_level', 'power_supply', 'property_unit',
            'province_id', 'res_code', 'tatal_tank_volume', 'total_mains_number', 'total_tank_number',
            'water_cooling_conf', 'zh_label'
        ],
        'room': [
