...
"""
高新兴260R门禁控制器协议解析脚本
用于解析高新兴260R门禁控制器协议的16进制码流
"""

from base_parser import BaseParser

class Gaoxin260RParser(BaseParser):
    """高新兴260R门禁控制器协议解析器"""
    
    def __init__(self):
        super().__init__()
        self.name = "高新兴260R门禁控制器协议"
...
if __name__ == "__main__":
    ...
    # 示例数据包（需要替换为实际的高新兴260R协议数据包）
    example_packet = "7E200180480002000112340D"
    
    print("=== 高新兴260R门禁控制器协议解析示例 ===")
