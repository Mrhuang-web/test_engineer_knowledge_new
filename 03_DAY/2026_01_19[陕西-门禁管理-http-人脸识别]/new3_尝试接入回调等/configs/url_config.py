...
external_config = {
    # 测试环境配置
    'test': {
        'server_root': '10.206.158.133:8080',  # 动环测试服务器地址
        'secret_key': 'your-test-secret-key',  # 测试环境密钥
        'use_https': False  # 测试环境是否使用HTTPS
    },
    # 正式环境配置
    'prod': {
        'server_root': '10.206.158.57:8080',  # 动环正式服务器地址
        'secret_key': 'your-prod-secret-key',  # 正式环境密钥
        'use_https': True  # 正式环境是否使用HTTPS
    },
    # 当前使用的环境
    'current_env': 'test'
}