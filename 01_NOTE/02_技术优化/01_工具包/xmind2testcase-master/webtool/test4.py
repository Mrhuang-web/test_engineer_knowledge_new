...
def extract_xmind_content(xmind_path: str, output_dir: str = None) -> List[Dict]:
    ...
    try:
        ...
        print("all_test_cases",all_test_cases)
...
if __name__ == '__main__':
    xmind_file = 'your_file.xmind'  # 替换为你的XMind文件路径
    excel_file = 'output.xlsx'
    json_output_dir = './json_output'  # JSON文件输出目录，设为None则不保存


    xmind_file = r'C:\Users\Administrator\Desktop\中心主题.xmind'
    excel_file = r'C:\Users\Administrator\Desktop\output.xlsx'
    json_output_dir = r'C:\Users\Administrator\Desktop\json_output'  # JSON文件输出目录，设为None则不保存
