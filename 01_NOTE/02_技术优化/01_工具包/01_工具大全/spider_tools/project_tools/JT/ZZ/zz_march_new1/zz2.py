...
class WriterFactory:
    @staticmethod
    def create_writer(index_category: str, **kwargs) -> DeviceWriter | MetaWriter | MapWriter | LinkWriter:
        writer = ZZAllInOneWriter(**kwargs)
        meta = writer._registry[index_category]
        return meta['cls'](index_name=writer._make_index_name(index_category), es=writer.es, index_type=index_category,
                           **kwargs)
